...
const navigation = [
  ...
  { name: 'Resume', props: {class: "bg-transparent hover:bg-primary-orange  font-semibold hover:text-white py-2 px-4 border border-primary-orange rounded"}, href: '#', current: false },
]
